...
public class SelectionScreen extends World{
    ...
    public void act(){
        if(Greenfoot.isKeyDown(p1Controls[0]) && selectorBox1 == null) {
            if(confirmButton.equals("")) confirmButton = p1Controls[0];
        ...
        if(Greenfoot.isKeyDown(p2Controls[0]) && selectorBox2 == null) {
            if(confirmButton.equals("")) confirmButton = p2Controls[0];
        ...
        if(Greenfoot.isKeyDown(p3Controls[0]) && selectorBox3 == null) {
            if(confirmButton.equals("")) confirmButton = p3Controls[0];
        ...
        if(Greenfoot.isKeyDown(p4Controls[0]) && selectorBox4 == null) {
            if(confirmButton.equals("")) confirmButton = p4Controls[0];
        ...
        if(frame > 60){
            if(Greenfoot.isKeyDown(confirmButton)) Greenfoot.setWorld(new Barnhouse());
